...
class bipedal_walker():
    ...
    def truncation_check(self,height,vec):
        ...
        # print(cosin < 0.93)
        return (self.time_steps_in_current_episode >= self.max_length) | (self.target_height[0] > height) | (cosin < 0.86)
    ...
    def get_reward_value(self,obs):
        ...
        # Penalty for using joints limit
        limit = 1
